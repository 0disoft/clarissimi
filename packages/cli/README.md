...
approval, import, config file loading, ledger validation, rebuild and static-page command I/O, and
maintainer-only analytics commands. It also owns the typed command descriptor and deterministic
Bash, Zsh, fish, and PowerShell completion generation used by `clarissimi completion <shell>`.
