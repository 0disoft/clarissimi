...
function renderHelp(): string {
  return [
    ...
    "  clarissimi recognize (--fixture <path> | --github-fixture <path>) --mode dry-run [--provider <id>] [--provider-model <model>] [--provider-endpoint <url>] [--provider-thinking disabled] [--json]",
