...
import {
  ...
  validateRootPackageManager as validateRootPackageManagerValues,
  validateRootTsconfigReferences as validateRootTsconfigReferenceValues,
  validateTrackedGeneratedOutputPaths as validateTrackedGeneratedOutputPathValues,
  validateWorkspaceContract as validateWorkspaceContractValues,
  validateWorkspaceInternalDependencies as validateWorkspaceInternalDependencyValues,
  validateWorkspacePackageManifest as validateWorkspacePackageManifestValues,
  validateWorkspacePackageManifestSurface as validateWorkspacePackageManifestSurfaceValues,
  validateWorkspacePackageTsconfigReferences as validateWorkspacePackageTsconfigReferenceValues,
} from "./release-readiness/workspace-contract.mjs";
...
} from "./release-readiness/package-script-contract.mjs";
export {
  credentialedReleaseEvidenceContract,
  dryRunDogfoodEvidenceContract,
  hostedCiEvidenceContract,
...
export const implementationTrackerContract = {
  ...
  requiredSnippets: [
    ...
    "Immutable `v0.6.0` is public and Marketplace `Latest`",
    "97398d030aaddf9568210181dda93031fd800584",
    "29892070069",
    "29892171054",
    "29892358683",
...
export const actionInputsOutputsDocumentContract = {
  ...
  requiredSnippets: [
    ...
    "`INPUT_CONFIG_PATH`, `INPUT_DRAFT_PATH`, `INPUT_MODE`, `INPUT_GATE_MODE`",
...
export const actionContractDocumentContract = {
  ...
  requiredSnippets: [
    ...
    "Human-readable text may follow the marker; the JSON marker remains",
...
export const actionPermissionsDocumentContract = {
  ...
  requiredSnippets: [
    ...
    "An opt-in gate workflow may use `pull_request_target`",
...
export function validateRootPackageManager(packageJson, contract = rootPackageManagerContract) {
  return validateRootPackageManagerValues(packageJson, contract);
}
...
export function validatePackageReleasePolicy(
  ...
  return validatePackageReleasePolicyValues(packageJson, policy, manifestPath);
}
...
export function validateWorkspaceContract(text, contract = workspaceContract) {
  return validateWorkspaceContractValues(text, contract);
}
...
export function validateWorkspacePackageManifest(
  ...
  return validateWorkspacePackageManifestValues(packageJson, packageDir, manifestPath, contract);
}
...
export function validateWorkspacePackageManifestSurface(
  ...
  return validateWorkspacePackageManifestSurfaceValues(
    packageJson,
    packageDir,
    manifestPath,
    contract,
...
export function validateWorkspaceInternalDependencies(
  ...
  return validateWorkspaceInternalDependencyValues(
    packageJson,
    packageDir,
    manifestPath,
    contract,
    workspaceContract.packageNameScope,
  );
}
...
export function validateTrackedGeneratedOutputPaths(
  ...
  return validateTrackedGeneratedOutputPathValues(paths, contract);
}
...
export function validateRootTsconfigReferences(
  ...
  return validateRootTsconfigReferenceValues(tsconfig, packageDirs, contract);
}
...
export function validateWorkspacePackageTsconfigReferences(
  ...
  return validateWorkspacePackageTsconfigReferenceValues(
    tsconfig,
    packageDir,
    tsconfigPath,
    contract,
...
export function validatePackageOwnershipContract(
  ...
  return validatePackageOwnershipContractValues(text, packageDirs, contract);
}
