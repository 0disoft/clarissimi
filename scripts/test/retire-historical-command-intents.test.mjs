...
test("retirement removes completed mutations and keeps exact-tag revalidation manual-only", () => {
  const input = [
    ...
    '[intents.release_v0_6_1_stable_publish]\nstatus = "configured"\nrun_policy = "agent_allowed"',
    '[intents.verify_marketplace_v0_6_1]\nstatus = "configured"\nrun_policy = "agent_allowed"',
    '[intents.promote_v0_to_v0_6_1]\nstatus = "configured"\nrun_policy = "agent_allowed"',
    '[intents.git_stage_v0_6_1_alias_authorization]\nstatus = "configured"\nrun_policy = "agent_allowed"',
    '[intents.git_commit_v0_6_1_alias_authorization]\nstatus = "configured"\nrun_policy = "agent_allowed"',
    '[intents.release_v0_6_0_stable_publish]\nstatus = "configured"\nrun_policy = "agent_allowed"',
    '[intents.verify_marketplace_v0_6_0]\nstatus = "configured"\nrun_policy = "agent_allowed"',
    '[intents.promote_v0_to_v0_6_0]\nstatus = "configured"\nrun_policy = "agent_allowed"',
    '[intents.git_stage_v0_6_0_alias_result]\nstatus = "configured"\nrun_policy = "agent_allowed"',
    ...
    '[intents.release_v0_6_1_post_tag_evidence]\nstatus = "configured"\nlifecycle = "oneshot"\nrun_policy = "agent_allowed"\ndescription = "Revalidate."\nrequired_after = ["release_v0_6_1_stable_publish"]',
    '[intents.release_v0_6_0_post_tag_evidence]\nstatus = "configured"\nlifecycle = "oneshot"\nrun_policy = "agent_allowed"\ndescription = "Revalidate."\nrequired_after = ["release_v0_6_0_stable_publish"]',
  ...
  assert.deepEqual(result.removed, [
    ...
    "release_v0_6_1_stable_publish",
    "verify_marketplace_v0_6_1",
    "promote_v0_to_v0_6_1",
    "git_stage_v0_6_1_alias_authorization",
    "git_commit_v0_6_1_alias_authorization",
    "release_v0_6_0_stable_publish",
    "verify_marketplace_v0_6_0",
    "promote_v0_to_v0_6_0",
    "git_stage_v0_6_0_alias_result",
  ...
  assert.deepEqual(result.manualOnly, [
    "release_v0_6_1_post_tag_evidence",
    "release_v0_6_0_post_tag_evidence",
